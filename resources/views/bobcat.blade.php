...
@section('title', 'Заказать минипогрузчик (Bobcat) в Красноярске')
@section('description', 'Минипогрузчики в Красноярске за 40 мин. от 1500 руб. Круглосуточно. Оперативно.')
@section('keywords', 'минипогрузчик, bobcat, аренда минипогрузчика, заказать минипогрузчик красноярск')
@section('ogimage'){{ asset('img/og/bobcat.jpg') }}@endsection

@section('content')
    <section id="offer-bobcat">
        <div class="container offer">
            ...
            <div class="row">
                <div class="col">
                    <h1 class="offer_title">Заказать минипогрузчик (Bobcat) в Красноярске</h1>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    ...
                    <div class="offer_item">
                        ...
                        <span class="offer_item-text">от 1500 руб.</span>
                    </div>
  ...
  уточняйте по телефону.</span>
    ...
    <section id="price">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="price_title">Стоимость заказа минипогрузчика</h2>
                </div>
            </div>
            <div class="row price-row">
                <div class="col price-col-img">
                    <img class="price_img" src="{{ asset('img/bobcat.png') }}" alt="Заказать минипогрузчик в Красноярске">
                </div>
                <div class="col">
                    <div class="specifications">
                        <ul class="list-group">
                            <li class="list-group-item"><span class="specification">Ковш</span><span class="spec-value">есть</span></li>
                            <li class="list-group-item"><span class="specification">Щётка</span><span class="spec-value">есть</span></li>
                            <li class="list-group-item"><span class="specification">Гидромолот</span><span class="spec-value">есть</span></li>
                            <li class="list-group-item"><span class="specification">Ямобур</span><span class="spec-value">есть</span></li>
                        </ul>
                    </div>
                    <div class="prices">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item prices_car-lift">
                                <div class="prices_car-lift_value">
                                    <span>Доставка до места работы </span>
    ...
    <section id="text">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2>Заказать минипогрузчик (Bobcat) в Красноярске</h2>
                    <p>Минипогрузчик в Красноярске незаменим при выполнении широкого спектра работ. Благодаря различному навесному оборудованию, (такому как ковш, щётка, гидромолот, ямобур)  с помощью минипогрузчика можно без особых трудозатрат вскрывать асфальтобетонные покрытия, разрушать конструкции, выравнивать и профилировать грунт, перемещать сыпучие материалы, устранять различные загрязнения и бурить грунт. Мы осуществляем круглосуточную аренду спецтехники по лучшим ценам, а время подачи составляет 30-40 минут.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container photos">
            ...
            <div class="row">
                <div class="col photos_item">
                    <a data-fancybox="gallery" href="{{ asset('img/photos/ev9.jpg') }}"><img class="photos_img" src="{{ asset('img/photos/min/ev9_min.jpg') }}" alt="Фото нашей работы 1"></a>
                </div>
                <div class="col photos_item">
                    <a data-fancybox="gallery" href="{{ asset('img/photos/ev10.jpg') }}"><img class="photos_img" src="{{ asset('img/photos/min/ev10_min.jpg') }}" alt="Фото нашей работы 2"></a>
                </div>
                <div class="col photos_item">
                    <a data-fancybox="gallery" href="{{ asset('img/photos/ev11.jpg') }}"><img class="photos_img" src="{{ asset('img/photos/min/ev11_min.jpg') }}" alt="Фото нашей работы 3"></a>
                </div>
                <div class="col photos_item">
                    <a data-fancybox="gallery" href="{{ asset('img/photos/ev12.jpg') }}"><img class="photos_img" src="{{ asset('img/photos/min/ev12_min.jpg') }}" alt="Фото нашей работы 4"></a>
                </div>
            </div>
        </div>
    </section>
