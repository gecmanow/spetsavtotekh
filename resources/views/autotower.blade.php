...
@section('title', 'Заказать автовышку в Красноярске')
@section('description', 'Автовышки в Красноярске за 40 мин. от 1200 руб. Круглосуточно. Оперативно.')
@section('keywords', 'автовышка, аренда автовышки, заказать автовышку красноярск')
@section('ogimage'){{ asset('img/og/autotower.jpg') }}@endsection

@section('content')
    <section id="offer-autotower">
        <div class="container offer">
            ...
            <div class="row">
                <div class="col">
                    <h1 class="offer_title">Заказать автовышку в Красноярске</h1>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    ...
                    <div class="offer_item">
                        ...
                        <span class="offer_item-text">от 1200 руб.</span>
                    </div>
  ...
  уточняйте по телефону.</span>
    ...
    <section id="price">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="price_title">Стоимость заказа автовышки</h2>
                </div>
            </div>
            <div class="row price-row">
                <div class="col price-col-img">
                    <img class="price_img" src="{{ asset('img/car_lift.png') }}" alt="Заказать автовышку в Красноярске">
                </div>
                <div class="col prices">
                    <ul class="list-group">
                        <li class="list-group-item prices_car-lift">
                            <div>
                                <span>Высота</span><span class="price_value"> 15 </span><span>м</span>
                            </div>
                        ...
                        <li class="list-group-item prices_car-lift">
                            <div>
                                <span>Высота</span><span class="price_value"> 22 </span><span>м</span>
                            </div>
                            <div class="prices_car-lift_value">
                                <span class="price_value">1500</span>
                                <span> руб/ч</span>
                                <span class="price_separator"> / </span>
                                <span class="price_value">от 3</span>
                                <span> ч</span>
                                <span class="price_separator"> / </span>
                        ...
                        <li class="list-group-item prices_car-lift">
                            <div>
                                <span>Высота</span><span class="price_value"> 29 </span><span>м</span>
                            </div>
                            <div class="prices_car-lift_value">
    ...
    <section id="text">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2>Аренда автовышки в Красноярске</h2>
                    <p>Аренда автовышки в Красноярске - наилучший способ произвести высотные работы. Данный вид спецтехники отлично подходит для всех видов строительных работ, ремонта и покраски фасада, монтажа и демонтажа наружной рекламы, установки кондиционеров и сплит-систем, монтажа систем безопасности и клининговых работ. Аренда автовышки заменит собой сложный монтаж строительных лесов и сборных конструкций. Нужно заказать автовышку в Красноярске? Обратившись в СпецАвтоТех Вы получите уверенность в качественно выполненной работе, вовремя поданную технику и соблюдение всех мер безопасности при работе. Мы предоставляем услуги аренды автовышки не только в Красноярске, но и в Красноярском крае. Работаем без посредников, поэтому вы получаете автовышку в Красноярске недорого.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container photos">
            ...
            <div class="row">
                <div class="col photos_item">
                    <a data-fancybox="gallery" href="{{ asset('img/photos/ev13.jpg') }}"><img class="photos_img" src="{{ asset('img/photos/min/ev13_min.jpg') }}" alt="Фото нашей работы 2"></a>
                </div>
                <div class="col photos_item">
                    <a data-fancybox="gallery" href="{{ asset('img/photos/ev4.jpg') }}"><img class="photos_img" src="{{ asset('img/photos/min/ev4_min.jpg') }}" alt="Фото нашей работы 4"></a>
                </div>
                <div class="col photos_item">
                    <a data-fancybox="gallery" href="{{ asset('img/photos/ev14.jpg') }}"><img class="photos_img" src="{{ asset('img/photos/min/ev14_min.jpg') }}" alt="Фото нашей работы 6"></a>
                </div>
                <div class="col photos_item">
                    <a data-fancybox="gallery" href="{{ asset('img/photos/ev8.jpg') }}"><img class="photos_img" src="{{ asset('img/photos/min/ev8_min.jpg') }}" alt="Фото нашей работы 8"></a>
                </div>
            </div>
        </div>
    </section>
